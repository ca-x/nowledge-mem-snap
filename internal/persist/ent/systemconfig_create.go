...
func (_c *SystemConfigCreate) SetPayload(v string) *SystemConfigCreate {
...
func (_c *SystemConfigCreate) check() error {
	...
	if _, ok := _c.mutation.Payload(); !ok {
		return &ValidationError{Name: "payload", err: errors.New(`ent: missing required field "SystemConfig.payload"`)}
	}
