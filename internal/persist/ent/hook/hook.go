...
// function as RunRecord mutator.
type RunRecordFunc func(context.Context, *ent.RunRecordMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f RunRecordFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.RunRecordMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.RunRecordMutation", m)
}
